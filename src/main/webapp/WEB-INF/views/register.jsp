                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div ng-show="frmregister.username.$invalid"
                                             class="badge badge-danger m-2">Vui lòng nhập tài khoản
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <form:input path="email" ng-model="email" name="email" required="required"
                                                    placeholder=""
                                                    id="CustomerEmail" class="" autocorrect="off"
                                                    autocapitalize="off" autofocus=""/>
                                        <div ng-show="frmregister.email.$error.email || !email.includes('@')"
