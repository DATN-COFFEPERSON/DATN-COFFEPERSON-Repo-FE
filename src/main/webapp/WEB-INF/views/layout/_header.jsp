...
<style>
    .move-text {
        ...
        font-size: 16px; /* Điều chỉnh kích thước phù hợp */
...
<div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="scrolling-text">
                        <h1 class="move-text">Chào mừng đã đến với quán Coffee Person</h1>
                    </div>
                </div>
                <div class="col-md-1 d-none d-lg-none d-md-block d-lg-block"></div>
                <div class="col-md-8 text-right">
                    <span class="user-menu d-block d-lg-none"><i class="anm anm-user-al" aria-hidden="true"></i
                    ></span>
                    <ul class="customer-links list-inline">
                        ...
                        <c:if test="${not empty sessionScope.userAdmin}">
                            <li><a href="/management#!/order-product">Tại quầy</a></li>
                            <li>|</li>
                        </c:if>
    ...
    <div class="header-wrap classicHeader animated d-flex">
        <div class="container-fluid">
            <div class="row align-items-center">
                <!--Desktop Logo-->
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block" style="display: flex; align-items: center;">
                    <a href="/" style="display: flex; align-items: center; text-decoration: none;">
                        <img src="/images/logo/img.png" alt="Logo"
                             style="max-width: 35px; height: auto; margin-right: 5px;">
                        <h1 style="font-size: 17px; font-weight: 600; color: rgb(39, 39, 39); line-height: 1; margin-top: 0; margin-bottom: 0;">
                            Coffee Person
                        </h1>
                    </a>
                </div>
                ...
                <div class="col-2 col-sm-3 col-md-3 col-lg-8">
                    ...
                    <nav class="grid__item" id="AccessibleNav">
                        ...
                        <ul id="siteNav" class="site-nav medium right hidearrow">
                            ...
                            <li class="lvl1 parent megamenu">
                                <a href="/product/list?kw="
                                >Menu <i class="anm anm-angle-down-l"></i>
                                </a>
                                <div class="megamenu style4">
                                    <ul class="grid grid--uniform mmWrapper">
                                        <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                            <a href="#" class="site-nav lvl-1">Danh mục sản phẩm</a>
                                            <ul class="subLinks">
                                                <c:forEach var="item" items="${cates}" end="4">
                                                    <li class="lvl-2">
                                                        <a
                                                                href="/product/list?cid=${item.id}"
                                        ...
                                        <li class="grid__item lvl-1 col-md-3 col-lg-3">
                                            ...
                                            <ul class="subLinks">
                                                <li class="lvl-2">
                                                    <a href="#" class="site-nav lvl-2"></a>
                                                </li>
                                                <c:forEach var="cate" items="${cates }" begin="5">
                                                    <li class="lvl-2">
                                                        <a
                                                                href="/product/list?cid=${cate.id}"
                                                                class="site-nav lvl-2"
                                                        >${cate.name}</a
                                                        >
                                                    </li>
                            ...
                            <li class="lvl1 parent megamenu">
                                <a href="/blog">Giới thiệu <i class="anm anm-angle-down-l"></i></a>
                            </li>
                            <li class="lvl1 parent megamenu">
                                <a href="/contact"
                ...
                >
                    <div class="logo">
                        <a href="index.html">
                            <img
                                    src="/assets/images/Shopicon1.svg"
    ...
    <div class="mobile-nav-wrapper" role="navigation">
        ...
        <ul id="MobileNav" class="mobile-nav">
            <li class="lvl1 parent megamenu"><a href="/home/index">trang chủ </a></li>
            <li class="lvl1 parent megamenu">
                ...
                <ul>
                    ...
                    <c:forEach var="cate" items="${categories }">
                        <li>
                            <a href="/product/list?cate=${cate.id}" class="site-nav"
                            >${cate.name}</a
                            >
                        </li>
                    </c:forEach>
            ...
            <li class="lvl1 parent megamenu">
                ...
                >Thương hiệu <i class="anm anm-plus-l"></i>
                </a>
                <ul>
                    <li><a href="product-layout-1.html" class="site-nav"> </a></li>
                </ul>
