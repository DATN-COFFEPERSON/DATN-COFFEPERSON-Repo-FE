...
<body ng-app="shopping-app" ng-controller="shopping-ctrl"
	...
	<div class="pageWrapper">
		<%@include file="../layout/_header.jsp"%>
			...
			<div class="slide">
				<div id="slides-shop" class="cover-slides" style="position: relative; overflow: hidden; width: 100%; height: 750.4px;">
        <div class="slides-control" style="position: relative; height: 100%;
    ...
    <nav class="slides-pagination"><a href="#1" class="">1</a><a href="#2" class="">2</a><a href="#3" class="current">3</a></nav></div>
