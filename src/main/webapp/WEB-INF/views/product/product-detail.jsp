        ...
        <div id="MainContent" class="main-content" role="main">
            ...
            <div id="ProductSection-product-template"
                ...
                <div class="product-single">
                            ...
                            <div class="product-single__meta">
                                ...
                                <div class="prInfoRow">
                                    <div class="product-stock">
                                        <span class="instock ">Đang bán</span>
                                    </div>
                                </div>
                                <p
										...
										<span
											...
											<span id="ProductPrice-product-template"><span
                                                    class="money">
                                                <fmt:formatNumber value="${product.product.price}" pattern="#,##0"/> VNĐ
                                            </span></span>

										</span>
                                </p>
                                <div class="product-single__description rte">
                                    <p>Coffee Person không chỉ là nơi thưởng thức cà phê mà còn là không gian tương tác,
                                        nơi bạn có thể thả mình vào không gian sáng tạo. Thiết kế hiện đại, bố trí bàn
                                        ghế linh hoạt và không gian mở rộng, tạo điều kiện cho cả cuộc trò chuyện bình
                                        thường hay thời gian riêng tư.</p>
                                </div>
                        ...
                        <div class="tab-container mb-5">
                            <div id="tab1" class="tab-content">
                                <div class="product-description rte">
                                    <p>
                                        Sản phẩm cà phê tại "Coffee Person" không chỉ đơn thuần là cốc cà phê ngon mà
                                        còn là sự kết hợp tinh tế giữa hương vị đắng ngọt và nghệ thuật. Với cà phê rang
                                        xay tỉ mỉ từ những hạt cà phê chất lượng nhất, từng ngụm cà phê tại đây không
                                        chỉ là trải nghiệm về hương vị mà còn là hành trình khám phá sâu hơn về cà
                                        phê.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="product-image">
                                        ...
                                        <form class="variants add">
                                            <button ng-click="cart.add(${p.product.id})"
                                                    class="btn btn-addto-cart" type="button" tabindex="0">THÊM VÀO GIỎ
                                                HÀNG
                                            </button>
                                        </form>
                    ...
                    <div style="width: 800px; height: 150px; margin: auto; border: 1px solid rgb(246, 246, 246);"
                         class="comment">
                        <h5 style="padding-left: 20px; margin: 0; position: relative; top: 10px; color: #000000; font-weight: 600;">
                            Bình Luận</h5>
                        <div style="padding:20px;" class="commentip"><input type="text"
                                                                            placeholder="Gửi đánh giá của bạn vào đây">
                        </div>
                        <div style="padding-left: 20px; margin: 0;">
                            <button style="cursor: pointer; width: 100px;height: 40px;  background: #ff708e; color: aliceblue;"
                                    type="submit">Bình Luận
                            </button>
                        </div>
                    </div>
