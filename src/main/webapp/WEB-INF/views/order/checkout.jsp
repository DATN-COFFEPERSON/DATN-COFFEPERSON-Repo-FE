            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                    <div class="customer-box returning-customer">
                        <h3>
                            <i class="icon anm anm-user-al"></i> Điền thông tin
                            <a href="#customer-login" id="customer"
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mb-3">
                    <div class="customer-box customer-coupon">
                        <h3 class="font-15 xs-font-13">
                            <i class="icon anm anm-gift-l"></i> Ưu đãi <a
                                href="#have-coupon"
                                class="text-white text-decoration-underline"
                                data-toggle="collapse"></a>
                        </h3>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                        <label for="input-firstname">Tên tài khoản<span
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                        <label for="input-firstname">Tên đầy đủ<span
                                                class="required-f">*</span>
                                        </label> <input disabled="disabled" name="fullname"
                                                        value="${userDetail.fullname}" id="input-firstname" type="text">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6 required">
                                        ...
                                        <div ng-show="frmOrder.address.$invalid"
                                             class="badge badge-danger m-2">Please enter address
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
